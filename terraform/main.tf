...
resource "google_compute_instance" "todo_project_vm" {
  name         = "todo-project-vm"
  machine_type = var.machine_type
  zone         = var.zone
  tags         = ["todo-stack", "jenkins-server"]
...
resource "google_compute_firewall" "admin_access_todo" {
  name    = "allow-todo-stack-admin-todo"
  network = "default"
